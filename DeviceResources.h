...
namespace DX
{
    ...
    public:
        ...
        void ExecuteAndWaitForGpuCompute();
        ...
        // Direct3D Accessors.
        //auto                        GetAdapter() const noexcept            { return m_adapter.Get(); } // new
        ...
        ID3D12CommandQueue*         GetComputeCommandQueue() const noexcept{ return m_computeCommandQueue.Get(); }  // Added this.
        ...
        auto                        GetComputeCommandList() const noexcept { return m_computeCommandList.Get(); }   // Added this.
    ...
    private:
        ...
        // Direct3D objects.
        Microsoft::WRL::ComPtr<IDXGIAdapter1>               m_adapter;      // Added this.
        Microsoft::WRL::ComPtr<ID3D12Device10>              m_d3dDevice;    // Supports Enhanced Barriers.
        //Microsoft::WRL::ComPtr<ID3D12Device5>               m_d3dDevice;    // Supports DXR.
        //Microsoft::WRL::ComPtr<ID3D12Device>                m_d3dDevice;
        Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList7>  m_commandList;  // Supports Enhanced Barriers.
        //Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList4>  m_commandList;  // Supports DXR.
        //Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList>   m_commandList;
        Microsoft::WRL::ComPtr<ID3D12CommandQueue>          m_commandQueue;
        Microsoft::WRL::ComPtr<ID3D12CommandAllocator>      m_commandAllocators[MAX_BACK_BUFFER_COUNT];

        // Added these to support async compute.
        Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList4>  m_computeCommandList;
        ...
        Microsoft::WRL::ComPtr<ID3D12Fence>                 m_computeFence; // Required for async compute.
