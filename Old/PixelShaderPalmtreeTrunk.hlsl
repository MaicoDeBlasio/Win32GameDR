...
{
    Texture2D<float3> DiffuseMap = ResourceDescriptorHeap[SrvUAVs::PalmtreeAlbedoSrv];
    Texture2D<float3> NormalMap = ResourceDescriptorHeap[SrvUAVs::PalmtreeNormalSrv];
